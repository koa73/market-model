...
# ====================== Load static models =====================
model_up = data.model_loader('weights_b25_150_52')
model_none = data.model_loader('weights_b25_150_133')
model_down = data.model_loader('weights_b25_150_70')
...
d2_dense = tf.keras.layers.Dense(6, activation='sigmoid', name='2')(concat)
d3_dense = tf.keras.layers.Dense(24, activation='sigmoid', name='3')(d2_dense)
